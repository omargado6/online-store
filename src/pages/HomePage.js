...
import camera from '../images/home/camera.jpg';
import Headphone from '../images/home/headphone.jpg';
import smartwatch from '../images/home/smartwatches.jpg';
function HomePage() {
  const categories = [
  ...
  return (
    <div className="Homepage w-5/6 m-auto p-7">
      {/* best category */}
      <div className="card w-8/12 h-96 max-md:h-72 m-auto bg-base-100 shadow-xl mb-3 hover:-translate-y-6 duration-700">
      ...
      <div className="flex flex-wrap justify-around gap-1 pt-3">
        {categories.map((ele) => (
          <div className="card w-2/5 max-sm:w-3/5 h-80 max-md:h-64 m-auto bg-base-100 shadow-xl mb-3 hover:-translate-y-2 duration-500" key={ele.id}>
